const descriptionForSaleProducts = {
  ...
  watch: {
    1: 'Мужские механические часы с автоподзаводом.',
    2: 'Мужской кварцевый хронограф. Калибр механизма FC-296.',
    3: 'Мужские кварцевые часы. LED подсветка. Центральные часовая, минутная и секундная стрелки.',
    4: 'Мужские кварцевые часы. Аналогово-цифровое отображение времени.',
  },
};
